    ...
    <>
      ...
      <div className="space-y-6">
        <div className="bg-bgPrimary p-5">
          ...
          <p>Một lần nữa chào mừng đến với website blog của chúng tôi, đây là phần hồ sơ dành cho bạn.</p>
          <p>
            Tại đây bạn có thể theo dõi các thông tin về website như:</p>
            <p>- Số lượng quản trị viên và cộng tác viên cùng thông tin của họ (tất nhiên là bạn chỉ xem được thôi)</p>
            <p>- Số lượng bài viết và bình luận cùng thống kê</p>
            <p>Bạn cũng có thể chỉnh sửa thông tin của bản thân và phản hồi lại cho chúng tôi. Hãy trải nghiệm và đừng ngần ngại góp ý nhé!</p>
        </div>
